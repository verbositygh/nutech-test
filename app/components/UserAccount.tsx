...
const UserAccount = (props: { login: { sessionInfo: any, login: VoidFunction, logout: VoidFunction } }) => {
    ...
    <>
      ...
      <div className={'mt-2 mb-4 flex items-center gap-2'}>
        <button
          ...
          disabled={typing.isTyping|| typing.isDeleting}
          onClick={handleGenerateAndLogin}>
          <div className={'absolute top-0 left-0 h-full w-full flex justify-center items-center'}>
            {
              typing.isTyping || typing.isDeleting ?
                <Loader2 className={'animate-spin'} size={20} /> :
                null
            }
          </div>
          <span className={`${typing.isTyping || typing.isDeleting ? 'opacity-0 cursor-not-allowed' : 'opacity-100'} flex items-center gap-2`}>
            <KeyRound size={20} />
            Generate Account and Login
          </span>
        </button>
        {
          props.login.sessionInfo && !typing.isTyping && !typing.isDeleting ?
